...
<div id="container">
  ...
  <div id="content">
    <div id="content_left">
      <p style="font-size:25px"><a href="#">Tạo sự kiện mới</a> </p>
      <hr />
      <form action="../controller/CreateEventProcess.php" method="post">
        <table style="margin-top:10px;margin-left:20px">
        <tr>
          <td>Tên sự kiện:</td>
          <td  colspan="3"><input type="text" size="51" name="eventName"></td>
        </tr>
         <tr>
          <td>Loại sự kiện:</td>
        ...
        <tr>
            ...
            <td><input type="text" id="cal1" readonly="true" name="eventStartDate" /></td>
            <td>Giờ:</td>
         ...
         <tr>
            ...
            <td><input type="text" id="cal2" readonly="true" name="eventEndDate" /></td>
            <td>Giờ:</td>
        ...
        <tr>
          <td>Danh sách khách mời:</td>
          <td><select MULTIPLE NAME="invite[]" size=3>
              <?php
					
					for($i=0;$i<count($friendID);$i++)
					{
						echo "<option value=".$friendID[$i].">";
						echo $friendName[$i];
        ...
        <tr>
          <td>Nội dung:</td>
          <td colspan="3"><textarea cols="39" rows="3" name="eventIntro"></textarea></td>
        </tr>
        <tr>
          <td><input type="submit" class ="btn" value="Tạo sự kiện" onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'"/>
      </form>
      </td>
      <td></td>
      </tr>
